app.config(function ($translateProvider) {
  $translateProvider.translations('en', {
	...
	PAR_3_2: "different editors/users (including bots) on a total of ",
	...
	PAR_5_4: "different languages since the start of our inspection, due to ",
	PAR_5_5: " test idioms used by Wikipedia developers.",
  ...
  $translateProvider.translations('pt', {
	...
	PAR_5_4: "diferentes idiomas desde o começo de nosso experimento, dada a presença de ",
	PAR_5_5: " idiomas de teste usados pelos desenvolvedores da Wikipedia.",
